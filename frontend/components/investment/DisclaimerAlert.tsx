...
export function DisclaimerAlert({
  ...
  const content =
    type === 'chat' ? (
      <p className="text-xs">
        ⚠️ Esta información es educativa y no constituye asesoramiento financiero. Consulta un
  ...
  return (
    ...
    >
      <AlertCircle
        className={cn(iconSize, 'mt-0.5 flex-shrink-0 text-amber-600 dark:text-amber-400')}
      />
