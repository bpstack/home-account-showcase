      ...
      <div className="max-w-md w-full space-y-6 text-center">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Esta cuenta está lista para usarse. Hemos configurado las categorías por defecto para
            ti.
          </p>
        </div>
            ...
            <div className="flex items-start gap-4 text-left">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Aún no has registrado ninguna transacción en esta cuenta. Las estadísticas
                  aparecerán automáticamente cuando añadas tu primer ingreso o gasto.
                </p>
              </div>
            </div>
          </CardContent>
